 ...
 * 3. Watch JavaScript files, trigger devScripts, devStyles, and previewReload tasks.
 ...
 * 2. Compresses the selected files into `theme.zip` using gulp-zip.
